...
#ifndef MASTERCPPPLAN_ARRAYLOCKFREEQUEUE_H
#define MASTERCPPPLAN_ARRAYLOCKFREEQUEUE_H
...
#include "ArrayLockFreeQueueImpl.h"


#endif //MASTERCPPPLAN_ARRAYLOCKFREEQUEUE_H
